...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/employee.css" rel="stylesheet" />
</head>
...
<aside class="aside">
    ...
    <div id="add-button" class="aside-item inactive">
        ...
        <h4 class="aside-title">Employee form</h4>
    </div>
</aside>
<main class="main">
    <div class="main-form">
        <h1>Request leave</h1>
        <form class="leave-form" action="${pageContext.request.contextPath}/leave/save" method="POST">
    ...
    <div class="main-list ${not empty employee ? "shifted" : ""}">
        ...
        <div class="leave-salary-container">
                                ...
                                <div class="employee-card">
                                    ...
                                    <div class="card-image">
                                        ...
                                        <div class="card-buttons">
                                            ...
                                            <form action="${pageContext.request.contextPath}/employees/delete" method="post" onsubmit="return confirm('Are you sure you want to delete this employee?');">
                                                <input type="hidden" name="id" value="${employee.id}" />
                                                <button type="submit">
                                    ...
                                    <div class="card-info">
                                        ...
                                        <div class="info-line">
                                            ...
                                            <hr/>
                                            <div class="label">
                                                <svg viewBox="0 0 16 16" fill="" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M1 5V1H7V5L4.5 7.5L8.5 11.5L11 9H15V15H11C5.47715 15 1 10.5228 1 5Z" fill=""></path> </g></svg>
                                                <p>Phone</p>
                                            </div>
                                        </div>
...
<script>
    ...
    const shiftColors = () => {
        if(mainSection.classList.contains('shifted')){
            ...
            addLink.classList.add("inactive");
